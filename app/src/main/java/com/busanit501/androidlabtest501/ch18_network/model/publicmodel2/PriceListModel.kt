...
//"parkngAt": "N",
//"bsnTime": "24시간 영업",
//"creatDt": "20240713075455",
//"imgFile1": "busan.go.kr/comm/getImage?srvcId=MULGAKIND&upperNo=4960&fileTy=IMG&fileNo=1",
//"imgName1": "당미옥_1.jpg",
//"imgFile2": "busan.go.kr/comm/getImage?srvcId=MULGAKIND&upperNo=4960&fileTy=IMG&fileNo=2",
//"imgName2": "당미옥_2.jpg",
//"idx": 4960,
//"sj": "당미옥",
//"mNm": "오승미",
//"adres": "부산 동래구 온천장로119번길 28 (온천동)부산 동래구 온천동 149-8",
//"tel": "051-558-6767",
//"cnCd": 602,
//"cn": "음식점",
//"localeCd": 108,
//"locale": "온천1동",
//"intrcn": "\u003Cp\u003E\u003Cspan style=\"text-align: left; color: rgb(51, 51, 51); text-transform: none; text-indent: 0px; letter-spacing: normal; font-family: 돋움,Dotum; font-size: 9pt; font-style: normal; font-weight: 400; word-spacing: 0px; float: none; display: inline !important; white-space: normal; orphans: 2; widows: 2; text-decoration-color: initial; text-decoration-style: initial; font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial;\"\u003E1986년부터 부모님께서 해 오신 전통 방식 그대로 한우뼈를 현장에서 고아냅니다.\u003C/span\u003E&nbsp;\u003C/p\u003E"
//},

class PriceListModel (
    // 변수명, 넘어온 데이터 변수명 일치하기.
    val getGoodPriceStore : GetGoodPriceStore
    )

class GetGoodPriceStore (
    val body : Body
)
