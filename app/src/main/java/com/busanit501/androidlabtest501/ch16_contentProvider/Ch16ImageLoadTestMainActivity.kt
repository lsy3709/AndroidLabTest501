...
//        setContentView(R.layout.activity_ch16_image_load_test_main)
        ...
        val requestGalleryLauncher = registerForActivityResult(
            ...
            try {
                ...
                binding.resultUserImage2.setImageBitmap(bitmap)
        ...
        binding.cameraBtn2.setOnClickListener {
            ...
            // 절대경로 위치, 각 앱마다 내부 저장소이고, 실물기기로 할 때는 접근이 제한.
            // 예, 실제 카메라로 찍은 사진의 위치
            //file.absolutePath : /storage/emulated/0/Android/data/com.busanit501.androidlabtest501/files/Pictures/JPEG_20240712_104142_20107602741154728.jpg
            ...
            val photoURI : Uri = FileProvider.getUriForFile(
                this@Ch16ImageLoadTestMainActivity,
                // 암호 처럼 사용하는 패키지명 일치.
