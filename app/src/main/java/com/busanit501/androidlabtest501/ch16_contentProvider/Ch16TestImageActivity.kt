...
import com.busanit501.androidlabtest501.databinding.ActivityCh16TestImageBinding
import java.io.File
import java.text.SimpleDateFormat
import java.util.Date

class Ch16TestImageActivity : AppCompatActivity() {
    // 갤러리, 카메라 앱 연동해서 데이터 가져오기.
    lateinit var binding: ActivityCh16TestImageBinding
    lateinit var filePath : String
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCh16TestImageBinding.inflate(layoutInflater)
