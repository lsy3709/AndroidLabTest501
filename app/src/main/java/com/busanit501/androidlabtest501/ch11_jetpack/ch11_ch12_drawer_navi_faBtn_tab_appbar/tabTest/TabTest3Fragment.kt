...
class TabTest3Fragment : Fragment() {
    lateinit var binding: FragmentTabTest3Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = FragmentTabTest3Binding.inflate(layoutInflater)
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentTabTest3Binding.inflate(layoutInflater,container,false)
